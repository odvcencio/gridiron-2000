...
- A practice draft at `/draft/practice`: before the real draft, a seated manager takes a few picks on the clock in a private copy of the room, in their real seat, against bots playing the other seats from their real Big Boards. It uses the real pool, draft order, and pick clock, starts from round 1, 5, 10, or 15, and saves nothing.
