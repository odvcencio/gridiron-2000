...
# v0.49.0 includes File/Files and MaxActionBodyBytes for managed actions. The
...
RUN go install m31labs.dev/gosx/cmd/gosx@v0.49.0 && GOSX_SKIP_VERSION_CHECK=1 /go/bin/gosx build --dev .
