...
# v0.53.4 includes native same-origin return targets, fragment-aware managed
...
RUN go install m31labs.dev/gosx/cmd/gosx@v0.53.4 && GOSX_SKIP_VERSION_CHECK=1 /go/bin/gosx build --dev .
