...
# v0.53.1 includes the native document contract, nonce-aware navigation,
...
RUN go install m31labs.dev/gosx/cmd/gosx@v0.53.1 && GOSX_SKIP_VERSION_CHECK=1 /go/bin/gosx build --dev .
