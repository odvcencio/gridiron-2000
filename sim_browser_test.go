...
// browserAppRoot moved to sim_child_test.go (no chromedp build tag): a
// plain HTTP test outside this file needs it too (see that function's own
// doc comment for the GOSX_APP_ROOT guard it applies).
