		...
		<If cond={data.viewer.signed_in || data.viewer.demo}>
			...
			<nav class="app-tabbar" aria-label="Quick navigation" data-navigation-surface="mobile-tabbar">
				...
				<Link href="/" class="app-tabbar__tab">
					<span class="app-tabbar__icon" data-icon="home" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10.6 12 3.4l9 7.2"></path><path d="M5.6 9.6V20.6h12.8V9.6"></path><path d="M9.8 20.6v-5.4h4.4v5.4"></path></svg></span>
					Home
				</Link>
				<If cond={data.viewer.has_seat}>
					<Link href="/team" class="app-tabbar__tab">
						<span class="app-tabbar__icon" data-icon="team" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3.6 4.6 6.1l1.9 4.1 2.1-1.1v11.3h6.8V9.1l2.1 1.1 1.9-4.1L15 3.6"></path><path d="M9 3.6a3 3 0 0 0 6 0"></path></svg></span>
						Team
					</Link>
				</If>
				...
				<button
					...
					data-gosx-disclosure-target="#primary-navigation-dialog"
				>
					<span class="app-tabbar__icon" data-icon="more" aria-hidden="true"><svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><circle cx="12" cy="5.2" r="1.7"></circle><circle cx="12" cy="12" r="1.7"></circle><circle cx="12" cy="18.8" r="1.7"></circle></svg></span>
					More
				</button>
			</nav>
		</If>
