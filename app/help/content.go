...
func buildCorpus() []Topic {
	...
	t = baseTopic("team", "lineups-locks-matchups-and-scoring", "Lineups, locks, matchups, and scoring", "Set the effective lineup before kickoff and read provisional versus final scoring honestly.", []string{"lineup", "starter", "bench", "lock", "kickoff", "matchup", "score", "scoring", "stat correction"}, []string{"when do lineups lock", "lineup deadline", "game lock", "fantasy points"}, []string{"starting lineup", "scorebug"})
	...
	t = baseTopic("commissioner", "commissioner-operations", "Commissioner operations", "Run a league intentionally: admission, setup, draft control, weekly processing, recovery, and isolated HQ.", []string{"commissioner", "admin", "setup", "invite", "start", "pause", "force", "undo", "close week", "HQ", "recovery", "operator"}, []string{"commissioner checklist", "commissioner handbook", "league admin", "how do I run the league"}, []string{"admin console", "commissioner HQ", "control room"})
	details(&t, "A commissioner with configured capability operating the owning league instance.", "Commissioner authorization, current league identity, and a read of state before every mutation.", "Dynasty/redraft; HQ is bounded read-only portfolio and links to owning league for writes.", "Ready, not-ready, scheduled, running, paused, stale, degraded, unavailable, failed, final, recovery-required.", "Draft, waiver, trade, lineup, close, and notification deadlines come from runtime configuration.", []string{"Verify identity, seats, order, schedule, readiness, and source health.", "Use typed confirmations for destructive/force actions.", "Read persisted result and activity receipt.", "After restart/stale response, reconcile before retry.", "Use HQ only to find attention; mutate in owning league."}, "HQ summaries are PII-free and do not merge sessions.", "Start/force/undo/close/reset/release can change durable state and name affected objects.", "Only documented action is reversible; final/reset controls require confirmation/audit.", "Commissioner sees receipt, current state, and next operation.", "Stale/double/unauthorized actions fail closed; peer failure is isolated.", "Follow handbook normal/restart recovery; never edit SQLite or reuse incompatible binary.", "League state/config, authorization, processors, health, activity, peer summaries.", "A scheduled meeting remains stopped until the commissioner intentionally confirms start.", "/admin")
	add(t)
...
var glossaryEntries = []GlossaryEntry{
	{Term: "person", Definition: "The human using Gridiron.", TopicID: "identity-admission-and-membership"}, {Term: "identity", Definition: "The authenticated account representing a person.", TopicID: "identity-admission-and-membership"}, {Term: "admission", Definition: "The policy decision granting a signed-in identity league access.", TopicID: "identity-admission-and-membership"}, {Term: "membership", Definition: "The persisted league relationship after admission; it may be seatless.", TopicID: "identity-admission-and-membership"},
	{Term: "team", Aliases: []string{"franchise", "club"}, Definition: "The durable football object owning a roster.", TopicID: "teams-team-seats-and-rosters"}, {Term: "team association", Definition: "The link between an admitted identity and a team.", TopicID: "teams-team-seats-and-rosters"}, {Term: "team seat", Aliases: []string{"seat"}, Definition: "Team-scoped responsibility for managing a roster.", TopicID: "teams-team-seats-and-rosters"}, {Term: "primary manager", Aliases: []string{"owner"}, Definition: "The primary role associated with a team seat.", TopicID: "roles-primary-co-manager-and-commissioner"}, {Term: "co-manager", Definition: "An optional second manager sharing a team seat under configured permissions.", TopicID: "roles-primary-co-manager-and-commissioner"}, {Term: "commissioner", Definition: "A person with an orthogonal league-operations capability.", TopicID: "roles-primary-co-manager-and-commissioner"}, {Term: "commissioner capability", Definition: "Authorization for league operations; it does not substitute for membership/team.", TopicID: "roles-primary-co-manager-and-commissioner"},
	{Term: "roster", Definition: "Players assigned to a team's configured slots/zones.", TopicID: "teams-team-seats-and-rosters"}, {Term: "lineup", Definition: "The effective starter/bench arrangement for a week.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "lineup slot", Definition: "A configured position or zone holding a player.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "lineup lock", Definition: "The kickoff/state boundary preventing normal slot edits.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "matchup", Definition: "A schedule-backed comparison of two teams for a week.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "schedule", Definition: "Runtime game/week calendar supplying kickoffs and timing.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "projection", Definition: "A non-authoritative estimate, never a final score.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "provisional score", Definition: "A score calculated before finalization.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "final score", Definition: "A score pinned by finalization/close processing.", TopicID: "lineups-locks-matchups-and-scoring"}, {Term: "stat correction", Definition: "A later authoritative change to a published stat/result.", TopicID: "lineups-locks-matchups-and-scoring"},
	{Term: "player pool", Definition: "Source-backed players available to the league.", TopicID: "players-free-agents-waivers-and-faab"}, {Term: "player", Definition: "A canonical football participant in the pool.", TopicID: "players-free-agents-waivers-and-faab"}, {Term: "free agent", Definition: "An eligible unrostered player available when rules allow.", TopicID: "players-free-agents-waivers-and-faab"}, {Term: "waiver", Definition: "The delayed acquisition process for an ineligible-immediate player.", TopicID: "players-free-agents-waivers-and-faab"}, {Term: "claim", Definition: "A submitted request for a waiver player.", TopicID: "players-free-agents-waivers-and-faab"}, {Term: "claim priority", Definition: "The runtime ordering rule resolving claims.", TopicID: "players-free-agents-waivers-and-faab"}, {Term: "FAAB units", Aliases: []string{"waiver budget", "bid units"}, Definition: "Non-currency units used by a configured claim processor.", TopicID: "players-free-agents-waivers-and-faab"},
	{Term: "Big Board", Aliases: []string{"draft board", "queue"}, Definition: "The current account's private ordered draft targets used by AUTO first.", TopicID: "big-board-and-autopick"}, {Term: "Ready", Definition: "A persisted manager signal that never starts the draft.", TopicID: "draft-order-readiness-and-clock"}, {Term: "draft order", Definition: "The configured sequence of team picks.", TopicID: "draft-order-readiness-and-clock"}, {Term: "on the clock", Definition: "The current persisted team eligible to select.", TopicID: "draft-order-readiness-and-clock"}, {Term: "pick", Definition: "One persisted draft selection with team/player/order.", TopicID: "draft-order-readiness-and-clock"}, {Term: "autopick", Definition: "AUTO selects current account's first available board target, then best available.", TopicID: "big-board-and-autopick"},
	{Term: "trade", Definition: "A proposed exchange between team seats.", TopicID: "trades-review-and-processing"}, {Term: "counter", Definition: "A replacement trade proposal responding to an offer.", TopicID: "trades-review-and-processing"}, {Term: "review", Definition: "Configured period/authority evaluating an accepted trade.", TopicID: "trades-review-and-processing"}, {Term: "veto", Definition: "Configured review outcome rejecting a trade.", TopicID: "trades-review-and-processing"}, {Term: "activity", Definition: "Persisted event history for manager, processor, commissioner, and correction actions.", TopicID: "activity-and-commissioner-notes"}, {Term: "audit", Definition: "Evidence trail explaining a consequential change.", TopicID: "activity-and-commissioner-notes"}, {Term: "Commissioner Note", Definition: "Operator explanation attached to a decision; it does not replace runtime state.", TopicID: "activity-and-commissioner-notes"}, {Term: "Players", Definition: "Route showing pool, free agents, waivers, and claims.", TopicID: "players-free-agents-waivers-and-faab"}, {Term: "Signal Wire", Definition: "Provisional mixed-source signals that never mutate fantasy scores.", TopicID: "data-state-and-freshness"}, {Term: "Pick'em", Definition: "Independent against-the-spread game with per-game locks and W-L-P.", TopicID: "pickem"}, {Term: "Preseason Blitz", Definition: "Bounded preseason side contest with its own slate and locks.", TopicID: "preseason-blitz"}, {Term: "league mode", Definition: "Configured format label such as dynasty or redraft.", TopicID: "getting-started"}, {Term: "normalized phase", Definition: "Canonical lifecycle token such as pre-draft or regular-season.", TopicID: "getting-started"}, {Term: "feature capability", Definition: "Runtime-supported, unsupported, or temporarily unavailable workflow status.", TopicID: "getting-started"}, {Term: "runtime source", Definition: "Executable config/state/auth/processor/feed owning a value.", TopicID: "data-state-and-freshness"},
	{Term: "live", Definition: "A fresh successful source or active workflow state; read its adjacent context.", TopicID: "data-state-and-freshness"}, {Term: "loading", Definition: "A read or action is still in progress; do not duplicate a mutation.", TopicID: "data-state-and-freshness"}, {Term: "empty", Definition: "A valid collection contains zero items.", TopicID: "data-state-and-freshness"}, {Term: "no-results", Aliases: []string{"no results"}, Definition: "The current query/filter matches nothing; the collection may still contain records.", TopicID: "data-state-and-freshness"}, {Term: "pending", Definition: "Work awaits a deadline, review, or processor.", TopicID: "data-state-and-freshness"}, {Term: "locked", Definition: "A time, rule, or final boundary prevents ordinary change.", TopicID: "data-state-and-freshness"}, {Term: "disabled", Definition: "A role, prerequisite, or capability prevents the action.", TopicID: "data-state-and-freshness"}, {Term: "stale", Definition: "A last-good snapshot is beyond its freshness window.", TopicID: "data-state-and-freshness"}, {Term: "degraded", Definition: "A source or partial read failed while last-good data remains.", TopicID: "data-state-and-freshness"}, {Term: "offline", Definition: "The source is knowingly offline or a fallback is serving.", TopicID: "data-state-and-freshness"}, {Term: "unavailable", Definition: "No reliable value exists for the requested scope.", TopicID: "data-state-and-freshness"}, {Term: "failed", Definition: "An attempted read or action failed and its effect must be stated.", TopicID: "data-state-and-freshness"}, {Term: "permission-denied", Aliases: []string{"permission denied"}, Definition: "The current identity lacks authorization.", TopicID: "data-state-and-freshness"}, {Term: "not-applicable", Aliases: []string{"not applicable"}, Definition: "Mode, phase, role, or capability makes the topic irrelevant.", TopicID: "data-state-and-freshness"},
}
