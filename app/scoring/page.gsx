	...
	return <div class="scoring-row">
		...
		<If cond={props.Editable}>
			<form class="scoring-row__form" method="post" action={props.SetAction} data-gosx-managed="true">
				...
				<input type="number" name="points" aria-label={"Points for " + props.Rule.Label} value={props.Rule.Points} class="scoring-input" step="any" min="-25" max="25" inputmode="decimal"></input>
