								...
								<div class="stat-tip__rows">
									...
									<If cond={player.rostered}>
										<div class="stat-tip__row">
											...
											<b class="mono" title={player.owner_name}>ROSTERED · {player.owner_abbr}<If cond={player.is_drafted}> · {player.drafted_label}</If></b>
										</div>
									</If>
				...
				<article class="pool-row pool-row--status" data-player-position={player.position}>
					...
					<details class="stat-tip">
						...
						<div class="stat-tip__panel">
							...
							<div class="stat-tip__rows"><div class="stat-tip__row"><span>Projection</span><b class="mono">{player.projection}</b></div><If cond={player.rostered}><div class="stat-tip__row"><span>Availability</span><b class="mono" title={player.owner_name}>ROSTERED · {player.owner_abbr}<If cond={player.is_drafted}> · {player.drafted_label}</If></b></div></If><If cond={player.on_waivers}><div class="stat-tip__row"><span>Availability</span><span class="mono">ON WAIVERS</span><b class="mono">{player.waiver_resolves}</b></div></If><If cond={player.free_agent}><div class="stat-tip__row"><span>Availability</span><b class="mono">FREE AGENT</b></div></If><If cond={player.claimed_by_me}><p class="stat-tip__hist mono">Claim filed for this player.</p></If><If cond={player.needs_drop && player.can_add}><p class="stat-tip__hist mono">Adding requires a drop from your full roster.</p></If></div>
