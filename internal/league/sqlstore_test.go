...
func TestV6SQLiteMigratesWaiverReceiptsToV7(t *testing.T) {
	...
	// (migrate013LockerPostCommissionerNote, wave C) — not
	// currentDBVersion's own step count — is the logical marker to
	// check; migrate010/migrate011 stamp no logical version at all (see
